...
// Custom Images representing the 8 services
const BASE_IMAGES = [
    "/images/social_media.png",
    "/images/brand_marketing.png",
    "/images/video_production.png",
    "/images/influencer.png",
    "/images/designing.png",
    "/images/product_shoots.png",
    "/images/marketing.png",
    "/images/web_development.png",
];

// Repeat the 8 custom images to fill the 20 slots required by the animation
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // Only prevent default if we are within the scroll boundaries of our animation
            if (!atTop && !atBottom) {
                e.preventDefault();
            }
    ...
    const smoothMorph = useSpring(morphProgress, { stiffness: 50, damping: 25, mass: 0.8 });

    // 2. Scroll Rotation (Shuffling): Starts after morph (e.g., > 600)
    // Rotates the bottom arc as user continues scrolling
    const scrollRotate = useTransform(virtualScroll, [600, 3000], [0, 360]);
    const smoothScrollRotate = useSpring(scrollRotate, { stiffness: 50, damping: 25, mass: 0.8 });
    ...
    return (
        <div 
            ...
            style={{ background: "radial-gradient(circle at top, #F2F4EF 0%, #FAF8F4 100%)" }}
        >
            {/* Background Logo */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
                <img 
                    src="/logo.jpeg" 
                    alt="Ads and Aces Logo" 
                    className="w-[80%] max-w-[600px] object-contain"
                    style={{ filter: "sepia(1) hue-rotate(-20deg) saturate(3) opacity(0.04)" }}
                />
            </div>
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2 px-4">
                    <motion.h1
                        ...
                        className="text-3xl font-serif italic tracking-tight text-gray-900 md:text-6xl"
                    >
                    ...
                    <motion.p
                        ...
                        className="mt-6 text-sm font-semibold tracking-[0.3em] text-[#D4836B] uppercase"
                    >
                ...
                >
                    <h2 className="text-4xl md:text-6xl font-serif italic text-gray-900 tracking-tight mb-6">
                        Creative Marketing Agency
                    </h2>
                    <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed font-medium">
                        We craft brands that command attention and campaigns that convert. <br className="hidden md:block" />
                        Bold strategy meets stunning creative.
                    </p>
                </motion.div>
